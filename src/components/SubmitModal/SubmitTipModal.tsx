      ...
      <Dialog {...dialogProps}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription className="text-pine-shadow-60">Please connect a wallet to submit the tip referendum.</DialogDescription>
          </DialogHeader>
          <PickExtension />
  ...
  if (modalStatus.type === "transaction_steps") {
    return (
      <Dialog {...dialogProps}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-midnight-koi">Submit Tip Referendum</DialogTitle>
            <DialogDescription className="text-pine-shadow-60">
